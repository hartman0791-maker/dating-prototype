    ...
    <main className="romantic-bg">
      <style
        dangerouslySetInnerHTML={{
          __html: `
            /* ====== Background: subtle animated romantic gradient ====== */
            .romantic-bg{
              min-height: 100vh;
              padding: 20px;
              display:flex;
            ...
            /* ====== Premium glass card + romantic entrance ====== */
            .card{
              width: 100%;
              max-width: 460px;
              border-radius: 28px;
      ...
      <div className="hearts" aria-hidden="true">
        ...
        <div className="heart" style={{ left: "22%", animationDuration: "11s", animationDelay: "-2s", transform: "rotate(45deg) scale(1.1)" }} />
        <div className="heart" style={{ left: "36%", animationDuration: "10s", animationDelay: "-5s" }} />
        <div className="heart" style={{ left: "52%", animationDuration: "12s", animationDelay: "-3s", transform: "rotate(45deg) scale(1.25)" }} />
        <div className="heart" style={{ left: "68%", animationDuration: "9.5s", animationDelay: "-6s" }} />
        <div className="heart" style={{ left: "82%", animationDuration: "11.5s", animationDelay: "-1s", transform: "rotate(45deg) scale(0.95)" }} />
      </div>
